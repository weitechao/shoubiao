...
public class TestDistance {
	...
	* @param lat2	位置2纬度
	...
	public static void main(String args[]) {
		//22.7074221,113.9666705
		double x1 = 22.7074221;
		double y1 = 113.9666705;
		double r[] = getRange(x1, y1, 1000);
		...
		double distance = Utils.calcDistance(x1, y1,r[0],y1);
		System.out.println(distance);
		System.out.println(Utils.calcDistance(x1, y1,r[1],y1));
	}
