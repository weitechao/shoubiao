...
CREATE TABLE `apilog` (
  ...
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42701 DEFAULT CHARSET=utf8;
...
/*Table structure for table `msg_4_info` */

DROP TABLE IF EXISTS `msg_4_info`;

CREATE TABLE `msg_4_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
...
/*Table structure for table `msg_5_info` */

DROP TABLE IF EXISTS `msg_5_info`;

CREATE TABLE `msg_5_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
...
/*Table structure for table `msg_6_info` */

DROP TABLE IF EXISTS `msg_6_info`;

CREATE TABLE `msg_6_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
...
/*Table structure for table `msg_7_info` */

DROP TABLE IF EXISTS `msg_7_info`;

CREATE TABLE `msg_7_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
...
/*Table structure for table `msg_8_info` */

DROP TABLE IF EXISTS `msg_8_info`;

CREATE TABLE `msg_8_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
...
/*Table structure for table `msg_9_info` */

DROP TABLE IF EXISTS `msg_9_info`;

CREATE TABLE `msg_9_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `imei` varchar(32) NOT NULL,
  `type` int(3) NOT NULL,
  `device_id` int(11) NOT NULL,
