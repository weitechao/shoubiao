...
CREATE TABLE `device_watch_hf_info` (
  ...
  `schoolLat` varchar(256) DEFAULT '',
  `schoolLng` varchar(256) DEFAULT '',
  `latestTime` varchar(256) DEFAULT '',
  `homeAddress` varchar(256) DEFAULT '',
  `homeLng` varchar(256) DEFAULT '',
  `homeLat` varchar(256) DEFAULT '',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=565889 DEFAULT CHARSET=utf8;
